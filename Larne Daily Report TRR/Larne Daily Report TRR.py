...
df1 = pd.read_excel(r'C:\Users\NataliSuportman\Documents\ArcGIS\Projects\Larne_Fibrus\STR_LRN1_Ribbon1A_COL_Duct For TRR.xlsx')
df2 = pd.read_excel(r'C:\Users\NataliSuportman\Documents\ArcGIS\Projects\Larne_Fibrus\STR_LRN1_Ribbon2A_COL_Duct For TRR.xlsx')
...
new_ribbon_a.insert(0, 'Larne', 'Ribbon A')
...
new_ribbon_a.insert(13, 'Total Sub-Duct installed?', '')
new_ribbon_a.insert(14, 'Remain Sub-Duct installed?', '')
new_ribbon_a.insert(15, 'Assisted Digs', '')
new_ribbon_a.insert(16, 'Desilts Sections', '')
new_ribbon_a.insert(17, 'Desilts Meterage', '')
...
new_ribbon_b.insert(0, 'Larne', 'Ribbon B')
...
new_ribbon_b.insert(13, 'Total Sub-Duct installed?', '')
new_ribbon_b.insert(14, 'Remain Sub-Duct installed?', '')
new_ribbon_b.insert(15, 'Assisted Digs', '')
new_ribbon_b.insert(16, 'Desilts Sections', '')
new_ribbon_b.insert(17, 'Desilts Meterage', '')
...
# Convert the DataFrama to xlsx writer
writer = pd.ExcelWriter('Larne Daily Rerort TRR.xlsx', engine='xlsxwriter')
new_table.to_excel(writer, sheet_name='Larne')
workbook = writer.book
worksheet = writer.sheets['Larne']
...
# Adding the various formats, colors, borders, percentages
...
worksheet.write('P2', '=O2 - M2', comma_format)
worksheet.write('P3', '=O3 - M3', comma_format)

# Calculating the percentage and adding the format
worksheet.write('L2', '=I2 / J2 ', per_format)
worksheet.write('L3', '=I3 / J3 ', per_format)

# Adding the total length checked for TRR and the format
worksheet.write('J2', 46606, comma_format)
worksheet.write('J3', 26003, comma_format)
worksheet.write('O2', 474, comma_format)
worksheet.write('O3', 302, comma_format)

# Adding the color on specific rows
...
# Adding the borders on specific rows
worksheet.conditional_format('B2:Q2', {'type': 'unique', 'format': bor_format})
worksheet.conditional_format('B3:Q3', {'type': 'unique', 'format': bor_format})
