...
df1 = pd.read_excel(
    r'C:\Users\NataliSuportman\Documents\ArcGIS\Projects\Warrenpoint_Fibrus\STR_WRP1_RibbonA_COL_Duct_For_TRR.xlsx')
df2 = pd.read_excel(
    r'C:\Users\NataliSuportman\Documents\ArcGIS\Projects\Warrenpoint_Fibrus\STR_WRP1_RibbonB_COL_Duct_For_TRR.xlsx')
...
new_ribbon_a.insert(0, 'Warrenpoint', 'Ribbon A')
...
new_ribbon_b.insert(0, 'Warrenpoint', 'Ribbon B')
...
writer = pd.ExcelWriter('Warrenpoint Daily Report TRR.xlsx', engine='xlsxwriter')
new_table.to_excel(writer, sheet_name='Warrenpoint')
workbook = writer.book
worksheet = writer.sheets['Warrenpoint']
...
# Adding the various formats, borders, colors, percentages
...
# Adding the color format to specific rows
