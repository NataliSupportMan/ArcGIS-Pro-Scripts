...
df1 = pd.read_excel(r'C:\Users\NataliSuportman\Documents\ArcGIS\Projects\Fivemiletown_Fibrus\STR_FVM1_RibbonA_COL_Duct For TRR.xlsx')
df2 = pd.read_excel(r'C:\Users\NataliSuportman\Documents\ArcGIS\Projects\Fivemiletown_Fibrus\STR_FVM1_RibbonB_COL_Duct For TRR.xlsx')
df3 = pd.read_excel(r'C:\Users\NataliSuportman\Documents\ArcGIS\Projects\Fivemiletown_Fibrus\STR_FVM1_RibbonC_COL_Duct For TRR.xlsx')


#Ribbon A
#Add a new columns and re-order the headers
df1 = df1[['TRR Crew', 'Sub Ducting Crew', 'Blockage Clearance Crew', 'id', 'Shape__Length_3', 'Duct Status ', 'Sub-Duct Installed?']]
df1.insert(5, 'No. of Sections', 1)
df1 = df1.rename(columns={'Shape__Length_3': 'Sum Shape Length',
...
#Ribbon B
#Add a new columns and re-order the headers
df2 = df2[['TRR Crew', 'Sub Ducting Crew', 'Blockage Clearance Crew', 'id', 'Shape__Length_3', 'Duct Status ', 'Sub-Duct Installed?']]
df2.insert(5, 'No. of Sections', 1)
df2 = df2.rename(columns={'Shape__Length_3': 'Sum Shape Length',
                          'No. of Sections': 'Sum No. of Sections'})
...
#Ribbon C
#Add a new columns and re-order the headers
df3 = df3[['TRR Crew', 'Sub Ducting Crew', 'Blockage Clearance Crew', 'id', 'Shape__Length_3', 'Duct Status ', 'Sub-Duct Installed?']]
df3.insert(5, 'No. of Sections', 1)
df3 = df3.rename(columns={'Shape__Length_3': 'Sum Shape Length',
                         'No. of Sections': 'Sum No. of Sections'})
...
df_all = pd.concat([new_df1, new_df2, new_df3])
...
writer = pd.ExcelWriter('Fivemiletown.xlsx', engine='xlsxwriter')
