...
new_ribbon_a.insert(0, 'Irvinestown', 'Ribbon A')
...
new_ribbon_b.insert(0, 'Irvinestown', 'Ribbon B')
...
new_ribbon_c.insert(0, 'Irvinestown', 'Ribbon C')
...
writer = pd.ExcelWriter('Irvinestown Daily Report TRR.xlsx', engine='xlsxwriter')
new_table.to_excel(writer, sheet_name='Irvinestown')
workbook = writer.book
worksheet = writer.sheets['Irvinestown']
...
worksheet.write('J2', 47590.2)
worksheet.write('J3', 14029.6)
worksheet.write('J4', 6895.7)
