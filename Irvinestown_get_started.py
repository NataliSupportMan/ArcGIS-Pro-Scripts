######################################## CALCULATE FIELDS from Feature layers for all Ribbons in Irvinestown Layer #############################################
...
ribbon_list = [
    ['Ribbon A/STR_IRV1_RibbonA_COL_Duct For TRR', 'L0bt_duct_route', 'L1STR_IRV1_RibbonA_COL_Duct_For_TRR_KN'],
    ['Ribbon B/STR_IRV1_RibbonB_COL_Duct For TRR', 'L0bt_duct_route', 'L1STR_IRV1_RibbonB_COL_Duct_For_TRR_KN'],
    ['Ribbon C/STR_IRV1_RibbonC_COL_Duct For TRR', 'L0bt_duct_route', 'L1STR_IRV1_RibbonC_COL_Duct_For_TRR_KN']
    ]
...
ribbon_layers = [
        ["Ribbon A/STR_IRV1_RibbonA_COL_Duct For TRR", "STR_IRV1_RibbonA_COL_Duct For TRR.xlsx"],
        ["Ribbon B/STR_IRV1_RibbonB_COL_Duct For TRR", "STR_IRV1_RibbonB_COL_Duct For TRR.xlsx"],
        ["Ribbon C/STR_IRV1_RibbonC_COL_Duct For TRR", "STR_IRV1_RibbonC_COL_Duct For TRR.xlsx"],
        ["Irvinestown Duct Blockage", "Irvinestown Duct Blockage.xlsx"],
        ]
