######################################## CALCULATE FIELDS from Feature layers for all Ribbons in Garrison Layer #############################################
...
ribbon_list = [
    ['Ribbon A/STR_GRS1_RibbonA_COL_Duct For TRR', 'L0bt_duct_route', 'L0STR_GRS1_RibbonA_COL_Duct_For_TRR_KN'],
    ['Ribbon B/STR_GRS1_RibbonB_COL_Duct For TRR', 'L0bt_duct_route', 'L1STR_GRS1_RibbonB_COL_Duct_For_TRR_KN']
    ]
...
ribbon_layers = [
        ["Ribbon A/STR_GRS1_RibbonA_COL_Duct For TRR", "STR_GRS1_RibbonA_COL_Duct For TRR.xlsx"],
        ["Ribbon B/STR_GRS1_RibbonB_COL_Duct For TRR", "STR_GRS1_RibbonB_COL_Duct For TRR.xlsx"],
        ["DFE_Garrison_TRR", "DFE_Garrison_TRR.xlsx"],
        ["Garrison Duct Blockage", "Garrison Duct Blockage.xlsx"],
        ]
