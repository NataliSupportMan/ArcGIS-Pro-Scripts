...
df1 = pd.read_excel(r'C:\Users\NataliSuportman\Documents\ArcGIS\Projects\STR GRS1 Full OLT CLD\STR GRS1 Full OLT CLD - Poles.xlsx')
df2 = pd.read_excel(r'C:\Users\NataliSuportman\Documents\ArcGIS\Projects\STR GRS1 Full OLT CLD\STR GRS1 Full OLT CLD - Chambers.xlsx')
df3 = pd.read_excel(r'C:\Users\NataliSuportman\Documents\ArcGIS\Projects\STR GRS1 Full OLT CLD\STR GRS1 Full OLT CLD - Fibre Cable.xlsx')
df4 = pd.read_excel(r'C:\Users\NataliSuportman\Documents\ArcGIS\Projects\STR GRS1 Full OLT CLD\STR GRS1 Full OLT CLD - Fibre Duct.xlsx')
df5 = pd.read_excel(r'C:\Users\NataliSuportman\Documents\ArcGIS\Projects\STR GRS1 Full OLT CLD\STR GRS1 Full OLT CLD - Splice Closures.xlsx')
df6 = pd.read_excel(r'C:\Users\NataliSuportman\Documents\ArcGIS\Projects\STR GRS1 Full OLT CLD\STR GRS1 Full OLT LLD - Vegetation Issues.xlsx')
...
df_all.loc[0, 'BOM QTY'] = 15252 # Tree length
df_all.loc[1, 'BOM QTY'] = 575 # Poles
#df_all.loc[2, 'BOM QTY'] = 368.93 # Civils
#df_all.loc[3, 'BOM QTY'] = 7 # Joint
#df_all.loc[4, 'BOM QTY'] = 222 # ODP
#df_all.loc[5, 'BOM QTY'] = 115510.18 # OH
#df_all.loc[6, 'BOM QTY'] = 22766.90 # UG
#df_all.loc[7, 'BOM QTY'] = 18114.31 # UG/OH
#df_all.loc[8, 'BOM QTY'] = 0 # Chambers

df_all = df_all[['TASK', 'BOM QTY', 'QTY COMPLETE']]
print(df_all)

# Transfer the Database to Excel writer to export the dataframe
writer = pd.ExcelWriter('STR GRS1 Full OLT CLD Daily Report.xlsx', engine='xlsxwriter',)

# Adding a variable
sheet_name = 'Garrison Build'
...
#Adding the header
worksheet.write_string(0, 1, 'Garrison Build', header_format)
