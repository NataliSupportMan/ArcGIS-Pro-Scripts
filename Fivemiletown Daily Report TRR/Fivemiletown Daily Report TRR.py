...
new_ribbon_a.insert(0, 'Fivemiletown', 'Ribbon A')
...
new_ribbon_b.insert(0, 'Fivemiletown', 'Ribbon B')
...
new_ribbon_c.insert(0, 'Fivemiletown', 'Ribbon C')
...
writer = pd.ExcelWriter('Fivemiletown Daily Report TRR.xlsx', engine='xlsxwriter')
new_table.to_excel(writer, sheet_name='Fivemiletown')
workbook = writer.book
worksheet = writer.sheets['Fivemiletown']
...
worksheet.write('J2', 17891)
worksheet.write('J3', 29176)
worksheet.write('J4', 15289)
