...
df1 = pd.read_excel(r'C:\Users\NataliSuportman\Documents\ArcGIS\Projects\STR_ENK1_Full_OLT_CLD\STR ENK1 Full OLT CLD - Poles.xlsx')
df2 = pd.read_excel(r'C:\Users\NataliSuportman\Documents\ArcGIS\Projects\STR_ENK1_Full_OLT_CLD\STR ENK1 Full OLT CLD - Chambers.xlsx')
df3 = pd.read_excel(r'C:\Users\NataliSuportman\Documents\ArcGIS\Projects\STR_ENK1_Full_OLT_CLD\STR ENK1 Full OLT CLD - Fibre Cable.xlsx')
df4 = pd.read_excel(r'C:\Users\NataliSuportman\Documents\ArcGIS\Projects\STR_ENK1_Full_OLT_CLD\STR ENK1 Full OLT CLD - Fibre Duct.xlsx')
df5 = pd.read_excel(r'C:\Users\NataliSuportman\Documents\ArcGIS\Projects\STR_ENK1_Full_OLT_CLD\STR ENK1 Full OLT CLD - Splice Closures.xlsx')
df6 = pd.read_excel(r'C:\Users\NataliSuportman\Documents\ArcGIS\Projects\STR_ENK1_Full_OLT_CLD\STR ENK1 Full OLT LLD Vegetation Issues.xlsx')
...
df_all.loc[0, 'BOM QTY'] = 37859.5 # Tree cutting
df_all.loc[1, 'BOM QTY'] = 70 # Joints
df_all.loc[2, 'BOM QTY'] = 15 # ODP1
df_all.loc[3, 'BOM QTY'] = 126 # ODP1/ODP2
df_all.loc[4, 'BOM QTY'] = 493 # ODP2
df_all.loc[5, 'BOM QTY'] = 1066 # Poles
df_all.loc[6, 'BOM QTY'] = 3807.88 # Civils
df_all.loc[7, 'BOM QTY'] = 223646.65 # OH
df_all.loc[8, 'BOM QTY'] = 111218.24 # UG
df_all.loc[9, 'BOM QTY'] = 64979.32 # UG/OH
#df_all.loc[10, 'BOM QTY'] = 493 # ODP2
#df_all.loc[11, 'BOM QTY'] = 9 # ODP3
#df_all.loc[12, 'BOM QTY'] = 5 # Chambers

df_all = df_all[['TASK', 'BOM QTY', 'QTY COMPLETE']]
print(df_all)

# Transfer the Database to Excel writer to export the dataframe
writer = pd.ExcelWriter('STR_ENK1_Full_OLT_LLD Daily Report.xlsx', engine='xlsxwriter')

# Adding a variable
sheet_name = 'Enniskillen Build'
...
#Adding the header
worksheet.write_string(0, 1, 'Enniskillen Build', header_format)
...
worksheet.conditional_format('B9:B9', {'type': 'unique', 'format': format1})
worksheet.conditional_format('B10:B10', {'type': 'unique', 'format': format1})
