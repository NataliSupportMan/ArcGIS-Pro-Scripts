...
df2 = pd.read_excel(r'C:\Users\NataliSuportman\Documents\ArcGIS\Projects\STR_ENK1_Full_OLT_CLD\STR ENK1 Full OLT CLD - Poles.xlsx')
df3 = pd.read_excel(r'C:\Users\NataliSuportman\Documents\ArcGIS\Projects\STR_ENK1_Full_OLT_CLD\STR ENK1 Full OLT CLD - Fibre Duct.xlsx')
df4 = pd.read_excel(r'C:\Users\NataliSuportman\Documents\ArcGIS\Projects\STR_ENK1_Full_OLT_CLD\STR ENK1 Full OLT CLD - Chambers.xlsx')
df5 = pd.read_excel(r'C:\Users\NataliSuportman\Documents\ArcGIS\Projects\STR_ENK1_Full_OLT_CLD\STR ENK1 Full OLT CLD - Fibre Cable.xlsx')
df6 = pd.read_excel(r'C:\Users\NataliSuportman\Documents\ArcGIS\Projects\STR_ENK1_Full_OLT_CLD\STR ENK1 Full OLT CLD - Splice Closures.xlsx')
...
sum_pole = df2.loc[df2['Status'] == 'Built', ['Status', 'Milestone']].groupby('Milestone').count()
...
sum_fibre_duct = df3.loc[df3['Status'] == 'Built', ['Shape__Length', 'Milestone']].groupby('Milestone').sum()
total_fibre_duct = pd.merge(group_mil3, sum_fibre_duct, right_index=True, left_index=True, how="outer")
total_fibre_duct = total_fibre_duct.rename(columns={'Shape__Length_x': 'Civils BOM', 'Shape__Length_y': 'Civils COM'})
...
df1.loc[df1['Milestone'] == 'ENK_001', 'Milestone'] = 'ENK_G_001'
df1.loc[df1['Milestone'] == 'ENK_002', 'Milestone'] = 'ENK_H_002'
df1.loc[df1['Milestone'] == 0, 'Milestone'] = 'ENK_0_000'

# Rename all specific rows in the databases for df2
df2.loc[df2['Milestone'] == 'ENK_001', 'Milestone'] = 'ENK_G_001'
df2.loc[df2['Milestone'] == 'ENK_002', 'Milestone'] = 'ENK_H_002'

# Rename all specific rows in the databases for df3
df3.loc[df3['Milestone'] == 'ENK_001', 'Milestone'] = 'ENK_G_001'
df3.loc[df3['Milestone'] == 'ENK_002', 'Milestone'] = 'ENK_H_002'

# Rename all specific rows in the databases for df4
df4.loc[df4['Milestone'] == 'ENK_001', 'Milestone'] = 'ENK_G_001'
df4.loc[df4['Milestone'] == 'ENK_002', 'Milestone'] = 'ENK_H_002'

# Rename all specific rows in the databases for df5
df5.loc[df5['Milestone'] == 'ENK_001', 'Milestone'] = 'ENK_G_001'
df5.loc[df5['Milestone'] == 'ENK_002', 'Milestone'] = 'ENK_H_002'

# Rename all specific rows in the databases for df6
df6.loc[df6['Milestone'] == 'ENK_001', 'Milestone'] = 'ENK_G_001'
df6.loc[df6['Milestone'] == 'ENK_002', 'Milestone'] = 'ENK_H_002'
...
com_civils = df3.loc[df3['Status'] == 'Built', ['Shape__Length', 'New Milestone']].groupby('New Milestone').sum()
com_civils = com_civils.rename(columns={'Shape__Length': 'Civils COM'})
...
df_8.loc[7, 'Ribbon'] = 'ENK_001' # Rename the row
df_8.loc[8, 'Ribbon'] = 'ENK_002' # Rename the row
...
writer = pd.ExcelWriter('Enniskillen Build Report.xlsx', engine='xlsxwriter')

# Adding a variable
sheet_name = 'Enniskillen Build Report'
...
worksheet.conditional_format('B34:T34', {'type': 'unique', 'format': format1})
worksheet.conditional_format('V1:AO1', {'type': 'unique', 'format': format1})
worksheet.conditional_format('V11:AO11', {'type': 'unique', 'format': format1})
