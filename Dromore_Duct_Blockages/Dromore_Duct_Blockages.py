...
df1 = pd.read_excel(r'C:\Users\NataliSuportman\Documents\ArcGIS\Projects\Dromore_Fibrus\STR_DRO1_COL_BT_Duct_Blockage_Coordinates.xlsx')
df2 = pd.read_excel(r'C:\Users\NataliSuportman\Documents\ArcGIS\Projects\Dromore_Fibrus\Dromore_Duct_Blockage_Online_Excel.xlsx')
df3 = pd.read_excel(r'C:\Users\NataliSuportman\Documents\ArcGIS\Projects\Dromore_Fibrus\STR_DRO1_COL_BT_Duct_Blockage_R_R_old_points.xlsx')
df2 = df2[['Editor']]
...
all_table.to_excel('Dromore Duct Blockages.xlsx', index=False)